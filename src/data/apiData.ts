...
export const apiEndpoints: ApiEndpoint[] = [
  ...
  // ── Image ──
  {
    ...
    description: "Upload an image via URL to the image service. The image is processed and stored internally. Save the returned image_url — it will be used when creating an image profile.",
  ...
  "details": [
    ...
    headers: [{ key: "Content-Type", value: "application/json" }, { key: "Accept", value: "application/json" }],
    requestBody: `{
  "url": "https://example.com/images/company-logo.bmp"
}`,
    responseBody: `{
  "id": "autogeneratedimageid",
  "image_url": "https://accessible-cdn-url.com/images/autogeneratedimageid.bmp"
}`,
    responseStatus: 201,
    product: ["bcd"]
  },
