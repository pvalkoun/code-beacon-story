...
export const endpointFieldDocs: Record<string, EndpointFieldDocs> = {
  ...
  "create-account": {
    requestFields: [
      ...
      { path: "billing.id", type: "String", required: true, description: "Billing identifier for the account", use: "Assigned by TransUnion or customer-defined" },
      { path: "billing.model", type: "String", required: true, description: "The billing model", use: "OTHER", restrictedValues: "TRANSACTION, SUBSCRIPTION" },
      { path: "billing.frequency", type: "String", required: true, description: "How often billing occurs", use: "MONTHLY", restrictedValues: "QUARTERLY, ANNUALLY" },
      { path: "service[].type", type: "String", required: true, description: "The service type to provision", use: "SDPR" },
