...
export const endpointFieldDocs: Record<string, EndpointFieldDocs> = {
  ...
  "create-image": {
    ...
    requestFields: [
      { path: "name", type: "String", required: true, description: "Client supplied name associated with the image", constraints: "The length is between 1 to 255, inclusive." },
      { path: "url", type: "URI", required: true, description: "Client supplied URL for downloading the image data", constraints: "Must be a valid URL" },
      { path: "note", type: "String", required: false, description: "Client supplied note associated with the image", constraints: "The length is between 1 to 255, inclusive." },
    ],
    responseFields: [
  ...
  "create-image-data": {
    ...
    requestFields: [
      { path: "name", type: "String", required: true, description: "Client supplied name associated with the image", constraints: "The length is between 1 to 255, inclusive." },
      { path: "data", type: "String", required: true, description: "Client supplied Base64-encoded image raw data", constraints: "The data must result in a valid image with its size under the system-defined limit" },
      { path: "note", type: "String", required: false, description: "Client supplied note associated with the image", constraints: "The length is between 1 to 255, inclusive." },
    ],
    responseFields: [
      { path: "id", type: "String", required: true, description: "Unique image ID assigned by the system" },
