...
export const endpointFieldDocs: Record<string, EndpointFieldDocs> = {
  ...
  "create-image": {
    ...
    requestFields: [
      ...
      { path: "url", type: "URI", required: false, description: "Client supplied URL for downloading the image data", constraints: "Must be a valid URL, if specified" },
      { path: "data", type: "String", required: false, description: "Client supplied Base64-encoded image raw data", constraints: "The data must result in a valid image with its size under the system-defined limit, if specified" },
