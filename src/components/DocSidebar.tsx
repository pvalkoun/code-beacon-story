                ...
                <Collapsible>
                  <SidebarMenuItem>
                    ...
                    <CollapsibleContent>
                        ...
                        <SidebarMenuItem>
                          <SidebarMenuButton asChild>
                            <NavLink to="/integrations/sinch" activeClassName="bg-sidebar-accent text-sidebar-primary font-medium" className="text-xs">
                              <Plug className="h-3.5 w-3.5 mr-2" />
            ...
            return (
              <div key={cat}>
                ...
                {isOpen && catEndpoints.map(ep => {
                  const isNew = productId === "bcd" && (ep.id === "create-image" || ep.id === "create-image-data" || ep.id === "update-image" || ep.id === "list-image" || ep.id === "get-image" || ep.id === "view-image" || ep.id === "delete-image" || ep.id === "create-image-profile" || ep.id === "get-image-profile" || ep.id === "list-image-profile" || ep.id === "delete-image-profile");
                  return (
                    <SidebarMenuItem key={ep.id}>
                      <SidebarMenuButton asChild>
                        <NavLink
