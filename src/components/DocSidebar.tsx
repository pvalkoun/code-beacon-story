            ...
            return (
              <div key={cat}>
                ...
                {isOpen && catEndpoints.map(ep => {
                  const isNew = productId === "bcd" && (ep.id === "create-image" || ep.id === "create-image-data" || ep.id === "list-image" || ep.id === "get-image" || ep.id === "view-image" || ep.id === "delete-image" || ep.id === "create-image-profile" || ep.id === "get-image-profile" || ep.id === "delete-image-profile");
                  return (
                    <SidebarMenuItem key={ep.id}>
                      <SidebarMenuButton asChild>
                        <NavLink
